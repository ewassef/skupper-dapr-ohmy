...
kubectl get secret -o yaml cluster1-secret --kubeconfig=cluster2.kubeconfig > .\token-request.yaml
#import the token to cluster1 using a replace 
kubectl apply -f .\token-request.yaml --kubeconfig=cluster1.kubeconfig